...
var (
	...
	javacVmFlagsList = []string{
		...
		"-J-XX:G1NewSizePercent=35",
		"-J-XX:G1MaxNewSizePercent=45",
		"-J-XX:G1HeapRegionSize=16M",
		"-J-XX:G1ReservePercent=10",
		"-J-XX:G1HeapWastePercent=4",
		"-J-XX:G1MixedGCCountTarget=4",
		"-J-XX:InitiatingHeapOccupancyPercent=15",
		"-J-XX:G1MixedGCLiveThresholdPercent=90",
		"-J-XX:G1RSetUpdatingPauseTimePercent=5",
		"-J-XX:SurvivorRatio=32",
...
func init() {
	...
	exportedVars.ExportStringListStaticVariable("DexFlags", []string{
		...
		"-JXX:+UseG1GC",
		"-JXX:+ParallelRefProcEnabled",
		"-JXX:MaxGCPauseMillis=500",
		"-JXX:+UnlockExperimentalVMOptions",
		"-JXX:+AlwaysPreTouch",
		"-JXX:+DisableExplicitGC",
		"-JXX:G1NewSizePercent=35",
		"-JXX:G1MaxNewSizePercent=45",
		"-JXX:G1HeapRegionSize=16M",
		"-JXX:G1ReservePercent=10",
		"-JXX:G1HeapWastePercent=4",
		"-JXX:G1MixedGCCountTarget=4",
		"-JXX:InitiatingHeapOccupancyPercent=15",
		"-JXX:G1MixedGCLiveThresholdPercent=90",
		"-JXX:G1RSetUpdatingPauseTimePercent=5",
		"-JXX:SurvivorRatio=32",
		"-JXX:+PerfDisableSharedMem",
		"-JXX:MaxTenuringThreshold=1",
	})
