...
func (c *deviceConfig) QTIAudioPath() string {
	return String(c.config.ProductVariables.Xos.QTIAudioPath)
}

func (c *deviceConfig) QTIDisplayPath() string {
	return String(c.config.ProductVariables.Xos.QTIDisplayPath)
}

func (c *deviceConfig) QTIMediaPath() string {
	return String(c.config.ProductVariables.Xos.QTIMediaPath)
}
